...
namespace PUPAcadPortal
{
    public partial class StudentActivityList : UserControl
    {
        ...
        public StudentActivityList(StudentCourse course)
        {
            ...
            flp.SizeChanged += (s, e) => RenderRows();
        ...
        private Panel BuildRow(StudentActivityItem act)
        {
            ...
            string btnText;
            if (act.SubmissionStatus == "Submitted")
                btnText = act.Type == "Quiz" ? "Answer Activity" : "View Submission";
            else
                btnText = "Take Activity";
            ...
            btn.Location = new Point(rowW - btn.Width - 12, 19);
            btn.Click += (s, e) =>
            {
