...
namespace PUPAcadPortal
{
    partial class SubmissionList
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btnReturnAll
            // 
            btnReturnAll.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            btnReturnAll.BackColor = Color.DarkOrange;
            btnReturnAll.BorderRadius = 10;
            btnReturnAll.FlatAppearance.BorderSize = 0;
            btnReturnAll.FlatStyle = FlatStyle.Flat;
            btnReturnAll.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            btnReturnAll.ForeColor = Color.White;
            btnReturnAll.Location = new Point(1510, 18);
            btnReturnAll.Name = "btnReturnAll";
            btnReturnAll.Size = new Size(115, 30);
            btnReturnAll.TabIndex = 5;
