...
{
    /// <summary>
    /// Full-screen-ish modal QR code dialog.
    /// Generates a pseudo-QR bitmap, counts down expiry, supports Download PNG.
    /// </summary>
    public sealed partial class QrCodePopupForm : Form
    {
        ...
        public QrCodePopupForm(string course, string session, DateTime date)
        {
            ...
            // Apply dynamic text to the UI controls created by the designer
            ...
            // Custom Paint events for borders
            pnlQrCard.Paint += (s, e) =>
            {
